...
def validate_license():
    ...
    # Use a dictionary cursor to get results with column names (e.g., license_record['revoked'])
...
# --- Admin Panel Routes ---
# Note: You should secure your admin panel. A simple way is to use a hard-to-guess URL
# or implement a proper admin login system.
@app.route('/admin') 
def admin_panel():
    conn = get_db_connection()
    cursor = conn.cursor(cursor_factory=psycopg2.extras.DictCursor)
